...
function handleConfirm() {
    ...
    if (currentTipIndex < tipsData.length - 1) {
        ...
        Progress.completeSubMode("hard_skills", "hard_lesson");
    }
}
...
async function loadData() {
    try {
        const response = await fetch('../db/hard_skills_tips.json');
        ...
        console.error('Error loading hard_skills_tips data:', error);
    }
}
